...
%     end
    ...
    j = 1;
    for m = 1 : rep : 7*rep % size(rec,2)/(3*rep)
...
%     end
    ...
    figure % tr, bw, freq
    plotFreq(x_t_p2_plot, y_t_p2_plot,[1/255 102/255 94/255],'x:',y_t_p2_sd,background.sum);
    plotFreq(x_t_p4_plot, y_t_p4_plot,[1/255 102/255 94/255],'x--',y_t_p4_sd,background.sum);
    plotFreq(x_t_p8_plot, y_t_p8_plot,[1/255 102/255 94/255],'x-',y_t_p8_sd,background.sum);
    createLegend({'2 bw','4 bw','8 bw'},[1/255 102/255 94/255; 1/255 102/255 94/255; 1/255 102/255 94/255],{':','--','-'},'best',1.5)    
    
    figure % tr, fw, freq
    plotFreq(x_t_n2_plot, y_t_n2_plot,[140/255 81/255 10/255],'x:',y_t_n2_sd,background.sum);
    plotFreq(x_t_n4_plot, y_t_n4_plot,[140/255 81/255 10/255],'x--',y_t_n4_sd,background.sum);
    plotFreq(x_t_n8_plot, y_t_n8_plot,[140/255 81/255 10/255],'x-',y_t_n8_sd,background.sum);
    createLegend({'2 fw','4 fw','8 fw'},[140/255 81/255 10/255; 140/255 81/255 10/255; 140/255 81/255 10/255],{':','--','-'},'best',1.5)
   
    figure % rot, cw, freq
    plotFreq(x_r_p2_plot, y_r_p2_plot,[1/255 102/255 94/255],'x:',y_r_p2_sd,background.sum);
    plotFreq(x_r_p4_plot, y_r_p4_plot,[1/255 102/255 94/255],'x--',y_r_p4_sd,background.sum);
    plotFreq(x_r_p8_plot, y_r_p8_plot,[1/255 102/255 94/255],'x-',y_r_p8_sd,background.sum);
    createLegend({'2 cw','4 cw','8 cw'},[1/255 102/255 94/255; 1/255 102/255 94/255; 1/255 102/255 94/255],{':','--','-'},'best',1.5)
    
    figure % rot, ccw, freq
    plotFreq(x_r_n2_plot, y_r_n2_plot,[140/255 81/255 10/255],'x:',y_r_n2_sd,background.sum);
    plotFreq(x_r_n4_plot, y_r_n4_plot,[140/255 81/255 10/255],'x--',y_r_n4_sd,background.sum);
    plotFreq(x_r_n8_plot, y_r_n8_plot,[140/255 81/255 10/255],'x-',y_r_n8_sd,background.sum);
...
%     load Temperature_ICN.mat
    ...
    for j = 1 : length(unitsave)
        ...
        if i == 1
            ...
            AllAni(k).Animal = str2double(file.name(42:44)); %str2double(file.name(65:66));
...
%         AllAni(k).(['R0',num2str(i)]).width.rotation.ccw = width.rn(:,unit);
        ...
        elseif exist('Ch1') == 1
            if contains(Ch1.title, 'Temp') == 1 %yes
                AllAni(k).(['R0',num2str(i)]).Temp = median(Ch1.values(find(Ch1.times > stim_times_start(1) & Ch1.times < stim_times_end(end))));
            else
                AllAni(k).(['R0',num2str(i)]).Temp = NaN;
            end
        else
